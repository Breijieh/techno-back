...
public interface EmployeeRepository extends JpaRepository<Employee, Long>, JpaSpecificationExecutor<Employee> {
    ...
    /**
     * Check if national ID exists excluding specific employee (for update validation)
     */
    ...
    /**
     * Find all employees with leave balance, with optional filters.
     ...
     * @param employmentStatus Employment status - optional (defaults to ACTIVE if not provided)
